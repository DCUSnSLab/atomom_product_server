...
# python demo4.py --Transformation TPS --FeatureExtraction ResNet --SequenceModeling BiLSTM --Prediction CTC --image_folder demo_image2/ --saved_model best_accuracy.pth --imgH 64 --imgW 200
...
아래 에러 
'''
# python demo3.py --Transformation TPS --FeatureExtraction RCNN --SequenceModeling BiLSTM --Prediction Attn --image_folder demo_image2/ --saved_model best_accuracy.pth --imgH 64 --imgW 200

# python demo3.py --Transformation TPS --FeatureExtraction RCNN --SequenceModeling BiLSTM --Prediction CTC --image_folder demo_image2/ --saved_model best_accuracy.pth --imgH 64 --imgW 200
