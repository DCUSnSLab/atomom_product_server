...
def test(opt):
    ...
    os.system(f'copy { str(opt.saved_model).replace(ch1,ch2) } .\\\\result\\\\{str(opt.exp_name).replace(ch1,ch2)}\\')
...
# python test2.py --eval_data data_lmdb/test --Transformation TPS --FeatureExtraction ResNet --SequenceModeling BiLSTM --Prediction CTC --saved_model saved_models/TPS-ResNet-BiLSTMCTC-Seed1111/best_accuracy.pth --imgH 64 --imgW 200 --workers 0